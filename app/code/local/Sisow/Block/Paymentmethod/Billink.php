<?php
class Sisow_Block_Paymentmethod_Billink extends Mage_Payment_Block_Form
{
    protected function _construct()
    {
        $this->setTemplate('sisow/checkout/billink_form.phtml');
        parent::_construct();
    }
    ...
    {
        return (boolean)Mage::getStoreConfig('payment/sisow_billink/useb2b') && !empty($this->getMethod()->getCompany());
    }
