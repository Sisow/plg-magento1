...
class Sisow_Model_Paymentfee_Invoice_Tax extends Mage_Sales_Model_Order_Invoice_Total_Abstract
{
    ...
    public function collect(Mage_Sales_Model_Order_Invoice $invoice)
    {
        ...
        $paymentFeeTax = $paymentFee - $paymentFeeExcludingVat;
        $basePaymentFeeTax =  $basePaymentFee - $basePaymentFeeExcludingVat;


        $invoice->setTaxAmount($totalTax + $paymentFeeTax);
        $invoice->setBaseTaxAmount($baseTotalTax + $basePaymentFeeTax);
